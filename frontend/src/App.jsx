...
function App() {
  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-start bg-gradient-to-br from-blue-50 to-blue-200 pb-5">
      <div className="w-full max-w-4xl flex flex-col flex-1 bg-white/90 rounded-lg shadow-lg mt-0 sm:mt-8 p-2 sm:p-6 h-screen min-h-[600px]">
        <h2 className="text-3xl font-bold mb-6 text-center text-blue-700">PDF RAG Chat</h2>
        ...
        <div className="flex-1 border border-gray-300 bg-white p-4 mb-4 rounded overflow-y-auto h-[50vh] min-h-[300px] max-h-[70vh] w-full transition-all">
          {chat.length === 0 && (
